export function Hero() {
  return (
    <section className="text-center px-4 pt-10 pb-8 fade-in">
      <p className="label-eyebrow mb-4">feito com amor · lg &amp; dc</p>
      ...
      <h1 className="font-serif text-4xl sm:text-5xl text-rose-deep">
        luiz gustavo <span className="text-rose-light italic">&amp;</span> débora cristina
      </h1>
      <p className="mt-5 max-w-md mx-auto text-sm leading-relaxed text-muted-foreground">
        ...
        que você capturou hoje <span className="text-rose-light">♡</span>
      </p>
    </section>
  );
}
